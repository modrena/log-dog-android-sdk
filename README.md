...
# LogDog for Android (Version: 1.0.63)
...
```gradle
plugins {
    id("com.modrena.logdog.plugin") version "1.0.63" // Dont forget to set the desired version
}

dependencies {
    implementation("com.modrena.logdog:logdog-sdk:1.0.63") // Dont forget to set the desired version
}
```
